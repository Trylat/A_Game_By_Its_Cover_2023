class_name OptionsMenuController extends Control
signal  close

const HSliderWLabel = preload("res://assetsLibrary/EasyMenus/Scripts/slider_w_labels.gd")
...
# does not exist
func load_options():
	assert(config.load(OptionsConstants.config_file_name) == OK)
